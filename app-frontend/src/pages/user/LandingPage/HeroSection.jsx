      ...
      <div className="w-11/12 md:w-1/2 flex">
        <div className="w-full md:w-2/3 md:ml-20">
          <div className="flex mt-6 space-x-10">
            <span className="px-6 py-2 bg-blue-100 text-blue-600 rounded-full text-xs font-medium">
              #Wellness
            </span>
            <span className="px-6 py-2 bg-green-100 text-green-600 rounded-full text-xs font-medium">
              #Mindfulness
            </span>
            <span className="px-6 py-2 bg-purple-100 text-purple-600 rounded-full text-xs font-medium">
              #Growth
            </span>
          </div>
          {/* <img
          ...
          /> */}
          <p className="text-7xl  font-normal tracking-tighter my-5 leading-[75px]">
